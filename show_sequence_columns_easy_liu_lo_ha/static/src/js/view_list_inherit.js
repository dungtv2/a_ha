odoo.define('show_sequence_columns_easy_liu_lo_ha.my_list_view', function (require) {
"use strict";
    ...
    View.include({
        ...
        render_fields_show: function () {
            ...
            if (this.fields_view.type == 'tree' && typeof(this.result) != 'undefined'){
                ...
                QWeb.add_template("/show_sequence_columns_easy_liu_lo_ha/static/src/xml/my_control.xml");
